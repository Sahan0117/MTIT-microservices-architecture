...
5. **Inventory API (Inventory-service)**: Manages stock levels, warehouse data, and inventory tracking.
...
- **Inventory API Proxy Route**: `http://localhost:8080/api/inventory` -> proxies to `5004`
